...
const api: GitTreeAPI = {
  ...
  getFileDiff: (repoPath, hash, filePath) => ipcRenderer.invoke('git:get-file-diff', repoPath, hash, filePath),
  getWipDetail: (repoPath) => ipcRenderer.invoke('git:get-wip-detail', repoPath),
